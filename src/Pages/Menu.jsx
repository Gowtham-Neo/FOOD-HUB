...
const Menu = () => {
  ...
  return (
    <div>
      ...
      {/* Main Cover */}
      <Cover img={menuImg} title="our menu" description="Welcome to FOOD HUB, where culinary excellence takes center stage on our diverse and enticing menu. Indulge in succulent steaks, exquisite seafood, and gourmet pasta crafted to perfection by our skilled chefs. "></Cover>
      {/* Offered */}
      <SectionTitle subHeading="Don't Miss" heading="Today's Offer"></SectionTitle>
      <MenuCategory items={offered}></MenuCategory>
      {/* Dessert Menu Item */}
      <MenuCategory items={dessert} title={"dessert"} img={dessertImg} description={"Indulge your sweet cravings with the divine desserts at FOOD HUB. Our dessert menu is a symphony of decadent delights, crafted to satisfy the most discerning sweet tooth. From the rich and velvety chocolate creations to the light and refreshing fruit-infused treats, each dessert is a masterpiece of flavor and presentation."}  ></MenuCategory>
      {/* Pizza menu Items */}
